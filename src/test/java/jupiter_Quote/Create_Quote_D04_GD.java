...
public class Create_Quote_D04_GD extends BaseTest {
...
//        identifierNumber = String.valueOf(generateFakeNumber());
        ...
        quotePage.selectToDropdownTypeQuote(driver, "Gia đình");
        ...
        quotePage.selectDropdownListSex(driver, "Nam");
    ...
    public void TC_01_Chuyen_PT_DNA(Method method) throws Exception {
        ...
        excel.setExcelFile("src/test/resources/D04_GD.xlsx", "Chuyen_PT_DNA");
        ...
        quotePage.inputEndDate(driver, excel.getCellData("Ngày kết thúc", 1));
        ...
        paymentFees = verifyEquals(quotePage.verifyPaymentFees(driver), excel.getCellData("Phí Thanh toán", 1));
        ...
        for (int i = 0; i < 179; i++) {
            ...
            quotePage.inputEndDate(driver, excel.getCellData("Ngày kết thúc", i + 2));
            ...
            paymentFees = verifyEquals(quotePage.verifyPaymentFees(driver), excel.getCellData("Phí Thanh toán", i + 2));
    ...
    public void TC_02_Chuyen_CC_DNA(Method method) throws Exception {
        ...
        excel.setExcelFile("src/test/resources/D04_GD.xlsx", "Chuyen_CC_DNA");
    ...
    public void TC_03_Chuyen_PT_CA(Method method) throws Exception {
        ...
        excel.setExcelFile("src/test/resources/D04_GD.xlsx", "Chuyen_PT_CA");
    ...
    public void TC_04_Chuyen_CC_CA(Method method) throws Exception {
        ...
        excel.setExcelFile("src/test/resources/D04_GD.xlsx", "Chuyen_CC_CA");
    ...
    public void TC_05_Chuyen_PT_TC(Method method) throws Exception {
        ...
        excel.setExcelFile("src/test/resources/D04_GD.xlsx", "Chuyen_PT_TC");
    ...
    public void TC_06_Chuyen_CC_TC(Method method) throws Exception {
        ...
        excel.setExcelFile("src/test/resources/D04_GD.xlsx", "Chuyen_CC_TC");
