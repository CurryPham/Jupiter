...
public class BasePageUI {
    ...
    public static final String  DYNAMIC_DROPDOWN_BUTTON_BY_TEXT = "xpath=//div[@class='col']//label[text()='%s']/following-sibling::div[@class='select-box-sm']//div[@class='select-box__indicators css-1wy0on6']";
    public static final String DYNAMIC_DROPDOWN_BY_TEXT = "xpath=//div[@title='%s']";
    public static final String WAIT_DROPDOWN = "xpath=//div[@class='select-box__menu css-26l3qy-menu'";
