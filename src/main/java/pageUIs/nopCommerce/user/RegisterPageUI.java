...
public class RegisterPageUI {
    ...
    public static final String REGISTER_LINK = "xpath=//button[@id='register-button']";
    ...
    public static final String NAV_TO_QUOTE_PAGE_SUCCESS = "xpath=//h3[text()='Tạo bản chào']";
