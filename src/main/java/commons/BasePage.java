...
public class BasePage {
    ...
    public void sendkeyAndSubmitToElement(WebDriver driver, String locatorType, String textValue, String... dynamicValues) {
        WebElement element = getWebElement(driver, getDynamicXpath(locatorType, dynamicValues));
        element.clear();
        element.sendKeys(textValue);
    ...
    public void submitToElement(WebDriver driver, String locatorType, String textValue, String... dynamicValues) {
        WebElement element = getWebElement(driver, getDynamicXpath(locatorType, dynamicValues));
        element.sendKeys(Keys.ENTER);
    }
    ...
    public void inputToDropdownByText(WebDriver driver, String dropdownText, String value) {
        sleepInSecond(3);
        clickToElement(driver, BasePageUI.DYNAMIC_DROPDOWN_BUTTON_BY_TEXT, dropdownText);
        waitForElementVisible(driver, BasePageUI.DYNAMIC_DROPDOWN_BY_TEXT, value, dropdownText);
        clickToElement(driver, BasePageUI.DYNAMIC_DROPDOWN_BY_TEXT, value, dropdownText);
    }
